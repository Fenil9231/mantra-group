                    ...
                    <div className="col-lg-7 col-md-6 ps-xl-5">
                        <div className="about-contents">
                            <div className="section-heading style-left">
                                ...
                                <p className="section-heading__desc">Real Estate is a vast industry that deals with the buying and selling of properties. It involves transactions related to residential</p>
