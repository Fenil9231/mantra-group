                                                    ...
                                                    <div className="col-12 py-2">
                                                        <div className="common-check">
                                                            ...
                                                            <div className="form-check-label">
                                                                ...
                                                                <Link to="/terms-and-conditions" className="text-decoration-underline text-main">Terms of Service</Link>
                                                                <label className="" htmlFor="remember"> and </label>
                                                                <Link to="/privacy-policy" className="text-decoration-underline text-main">Privacy Policy</Link>
                                                            </div>
                                                        </div>
                                                    </div>
                                                )
