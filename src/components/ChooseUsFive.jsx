                    ...
                    <div className="col-lg-6 ps-lg-5">
                        <div className="choose-us__content">
                            <div className="section-heading mb-0 style-left">
                                ...
                                <p className="section-heading__desc text-white fw-light font-18">Real Estate is a vast industry that deals with the buying and selling of properties. It involves transactions related to residential Real Estate is a vast industry that deals with the buying and selling </p>
