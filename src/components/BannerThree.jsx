                            ...
                            <div className="col-lg-6">
                                <div className="banner-inner position-relative">
                                    <div className="banner-content">
                                        <span className="banner-content__subtitle text-uppercase font-14 text-gradient">{bannerContent.subtitle}</span>
                                        <h1 className="banner-content__title">{bannerContent.title}
                                            <span className="position-relative d-inline">
                                            {bannerContent.shapedTitle}
                                                <img src="assets/images/shapes/curve-shape.png" alt="" className="curve-shape"/> 
                                            </span> 
                                        </h1>
                                        <p className="banner-content__desc font-18 mb-4 mb-lg-5">{bannerContent.desc}</p>
                                    </div>            
                                </div>
                            </div>
